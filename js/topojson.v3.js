...
(function (global, factory) {
  ...
  var filterWeight = function (topology, minWeight, weight) {
    ...
    return function (ring, interior) {
      return (
        weight(feature(topology, { type: "Polygon", arcs: [ring] }).geometry.coordinates[0], interior) >= minWeight
      );
    };
  };
  ...
  var newHeap = function () {
    ...
    heap.remove = function (removed) {
      ...
      if (i !== --size)
        (object = array[size]), (compare(object, removed) < 0 ? up : down)((array[(object._ = i)] = object), i);
      return i;
    };
